        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold text-white">LinguaLeap</span>
            </div>
            <p className="text-gray-400 mb-4">
              Empowering global teams with effective communication strategies and language training solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <a href="mailto:info@lingualead.com" className="text-gray-400 hover:text-white transition-colors">
                  info@lingualead.com
                </a>
              </li>
              <li className="flex items-start">
